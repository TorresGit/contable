...
class EmpresaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $empresas = $em->getRepository('AmdPiperBundle:Empresa')->findAll();
    ...
    {
        $empresa = new Empresa();
        $form = $this->createForm('Amd\PiperBundle\Form\EmpresaType', $empresa);
    ...
    {
        $deleteForm = $this->createDeleteForm($empresa);
        $editForm = $this->createForm('Amd\PiperBundle\Form\EmpresaType', $empresa);
