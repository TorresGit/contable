...
use Amd\PiperBundle\Entity\Item;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $items = $em->getRepository('AmdPiperBundle:Item')->findAll();
    ...
    {
        $item = new Item();
        $form = $this->createForm('Amd\PiperBundle\Form\ItemType', $item);
    ...
    {
        $deleteForm = $this->createDeleteForm($item);
        $editForm = $this->createForm('Amd\PiperBundle\Form\ItemType', $item);
