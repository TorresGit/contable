...
use Amd\PiperBundle\Entity\Banco;
...
class BancoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $bancos = $em->getRepository('AmdPiperBundle:Banco')->findAll();
    ...
    {
        $banco = new Banco();
        $form = $this->createForm('Amd\PiperBundle\Form\BancoType', $banco);
    ...
    {
        $deleteForm = $this->createDeleteForm($banco);
        $editForm = $this->createForm('Amd\PiperBundle\Form\BancoType', $banco);
