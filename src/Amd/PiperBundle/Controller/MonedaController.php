...
use Amd\PiperBundle\Entity\Moneda;
...
class MonedaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $monedas = $em->getRepository('AmdPiperBundle:Moneda')->findAll();
    ...
    {
        $moneda = new Moneda();
        $form = $this->createForm('Amd\PiperBundle\Form\MonedaType', $moneda);
    ...
    {
        $deleteForm = $this->createDeleteForm($moneda);
        $editForm = $this->createForm('Amd\PiperBundle\Form\MonedaType', $moneda);
